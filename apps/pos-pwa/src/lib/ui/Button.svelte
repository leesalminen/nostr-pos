<script lang="ts">
  ...
  const classes = $derived(
    [
      'inline-flex min-h-12 items-center justify-center gap-2 rounded-md px-5 py-3 text-sm font-semibold transition active:translate-y-px disabled:cursor-not-allowed disabled:opacity-50',
      variant === 'primary' && 'bg-[#1f513a] text-[#fffaf0] shadow-sm hover:bg-[#17442f]',
